...
fn uw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Uw(2, MoveVariant::Standard)).state(), vec![
        U, U, U, U, U, U, U, U, U, U, U, U, U, U, U, U, 
...
fn rw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Rw(2, MoveVariant::Standard)).state(), vec![
...
fn fw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Fw(2, MoveVariant::Standard)).state(), vec![
...
fn lw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Lw(2, MoveVariant::Standard)).state(), vec![
...
fn dw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Dw(2, MoveVariant::Standard)).state(), vec![
        U, U, U, U, U, U, U, U, U, U, U, U, U, U, U, U, 
        R, R, R, R, R, R, R, R, F, F, F, F, F, F, F, F, 
        F, F, F, F, F, F, F, F, L, L, L, L, L, L, L, L, 
        D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, D, 
...
fn bw2_move(cube: impl Cube) {
    assert_eq!(cube.apply_move(Move::Bw(2, MoveVariant::Standard)).state(), vec![
